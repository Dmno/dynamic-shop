...
class DesignRepository extends ServiceEntityRepository
{
    ...
    public function getDesignWithJoins(): array
    {
        return $this->createQueryBuilder('d')
            ...
            ->select('d.id, d.title, d.titleFontSize, l.title as logo, d.pageColor, d.secondaryPageColor, d.textColor, d.secondaryTextColor, d.productTitle, d.phoneNumber, d.companyName, d.address, d.country, d.postalCode, d.copyright, d.productCount, d.currency, i.title as backgroundImage')
            ->getQuery()
            ->getSingleResult();
    }
